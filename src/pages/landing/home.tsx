...
try {
  ...
  SOCKET_URL = parsedUrl.origin;
} catch (e) {
  console.warn("VITE_API_URL no es una URL válida, usando default");
}

// Exportamos el socket por si otros componentes necesitan escucharlo directamente
export const socket = io(SOCKET_URL, {
  withCredentials: true,
  transports: ["websocket", "polling"], // Forzar websocket primero por si hay problemas de proxy en prod
